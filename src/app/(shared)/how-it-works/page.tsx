...
const STEP_IMAGES = {
  ...
  brands: [
    "https://images.unsplash.com/photo-1556761175-5973dc0f32e7?w=900&q=80", // corporate meeting/office
    "https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=900&q=80", // brand activation/event
    "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=900&q=80", // festival/celebration
    "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=900&q=80", // conference/corporate event
  ],
};
    ...
    steps: [
      {
        ...
        desc: "Browse active campaigns and rising artists that align with your brand. Filter by city, genre, and audience size.",
      },
      {
        title: "Sponsor or Book",
        desc: "Sponsor a fan-powered campaign for brand exposure, or book an artist directly for your corporate event.",
      },
      {
        title: "Amplify Your Reach",
        desc: "Get your brand in front of passionate, engaged music fans. Logo placement, on-stage mentions, and social features.",
      },
      {
        title: "Measure Impact",
        desc: "Track sponsorship performance, audience engagement, and brand impressions from your dashboard.",
      },
    ],
  },
];
...
export default function HowItWorksPage() {
  const [activePerspective, setActivePerspective] = useState<"fans" | "artists" | "venues" | "brands">("fans");
  ...
  function handlePerspectiveChange(id: "fans" | "artists" | "venues" | "brands") {
